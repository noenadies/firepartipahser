...
(function() {
    ...
    return b.game = null, b.WEBGL_RENDERER = 0, b.CANVAS_RENDERER = 1, b.VERSION = "v2.2.9", b._UID = 0, "undefined" != typeof Float32Array ? (b.Float32Array = Float32Array, b.Uint16Array = Uint16Array, b.Uint32Array = Uint32Array, b.ArrayBuffer = ArrayBuffer) : (b.Float32Array = Array, b.Uint16Array = Array), b.PI_2 = 2 * Math.PI, b.RAD_TO_DEG = 180 / Math.PI, b.DEG_TO_RAD = Math.PI / 180, b.RETINA_PREFIX = "@2x", b.DisplayObject = function() {
        ...
        if (this.updateTransform(), this._cachedSprite) this._cachedSprite.texture.resize(1 | a.width, 1 | a.height);
        else {
        ...
        if (!(!this.visible || 0 === this.alpha || !this.renderable || this.texture.crop.width <= 0 || this.texture.crop.height <= 0)) {
            ...
            if (c && (d = c), this.blendMode !== a.currentBlendMode && (a.currentBlendMode = this.blendMode, a.context.globalCompositeOperation = b.blendModesCanvas[a.currentBlendMode], a.fd.on && a.fd.cb(this.blendMode)), this._mask && a.maskManager.pushMask(this._mask, a), this.texture.valid) {
                ...
                if (f /= e, g /= e, 16777215 !== this.tint)(this.texture.requiresReTint || this.cachedTint !== this.tint) && (this.tintedTexture = b.CanvasTinter.getTintedTexture(this, this.tint), this.cachedTint = this.tint), a.context.drawImage(this.tintedTexture, 0, 0, h, i, f, g, h / e, i / e);
                else {
        ...
        if (this.visible && !(this.alpha <= 0) && this.children.length) {
            ...
            for (var e = 0; e < this.children.length; e++) {
                ...
                if (f.visible) {
                    var g = f.texture,
                        h = g.frame;
                    if (b.globalAlpha = this.worldAlpha * f.alpha, f.rotation % (2 * Math.PI) === 0) d && (b.setTransform(c.a, c.b, c.c, c.d, c.tx, c.ty), d = !1), b.drawImage(g.baseTexture.source, h.x, h.y, h.width, h.height, f.anchor.x * (-h.width * f.scale.x) + f.position.x + .5 | 0, f.anchor.y * (-h.height * f.scale.y) + f.position.y + .5 | 0, h.width * f.scale.x, h.height * f.scale.y), a.fd.on && a.fd.csb1(g, h.width, h.height, g.baseTexture.resolution);
                    else {
        ...
        this.game = a, b.defaultRenderer || (b.defaultRenderer = this),
            this.type = b.CANVAS_RENDERER, this.resolution = a.resolution, this.clearBeforeRender = a.clearBeforeRender, this.transparent = a.transparent, this.autoResize = !1, this.width = a.width * this.resolution, this.height = a.height * this.resolution, this.view = a.canvas, this.context = this.view.getContext("2d", {
                alpha: this.transparent
    ...
    function() {
        ...
        window.console || (window.console = {}, window.console.log = window.console.assert = function() {}, window.console.warn = window.console.assert = function() {}), c.Utils = {
            ...
            cr: function() {
                this.frame.push({
                    type: this.CANVAS_CLEAR
                })
            },
            tu: function() {
                this.frame.push({
                    type: this.UPDATE_TEXT,
                    time: Date.now()
                })
            },
            cts: function(a, b, c) {
            ...
            cgc: function() {
                this.frame.push({
                    type: this.CANVAS_RENDER_GRAPHICS_CACHED
                })
            },
            cg: function() {
                this.frame.push({
                    type: this.CANVAS_RENDER_GRAPHICS
                })
            },
            rgs: function() {
                this.frame.push({
                    type: this.CANVAS_GRAPHICS_START,
                    time: Date.now()
                })
            },
            rgp: function() {
                this.frame.push({
                    type: this.CANVAS_GRAPHICS_STOP,
                    time: Date.now()
                })
            },
            cgpoly: function(a) {
                this.frame.push({
                    type: this.CANVAS_GRAPHICS_POLY,
                    time: Date.now(),
                    points: a
                })
            },
            cgrect: function() {
                this.frame.push({
                    type: this.CANVAS_GRAPHICS_RECT,
                    time: Date.now()
                })
            },
            cgcirc: function() {
                this.frame.push({
                    type: this.CANVAS_GRAPHICS_CIRCLE,
                    time: Date.now()
                })
            },
            cgrrect: function() {
                this.frame.push({
                    type: this.CANVAS_GRAPHICS_ROUNDED_RECT,
                    time: Date.now()
                })
            },
            cgelip: function() {
                this.frame.push({
                    type: this.CANVAS_GRAPHICS_ELIPSE,
                    time: Date.now()
                })
            },
            ...
            cb: function(a) {
                this.frame.push({
                    type: this.CANVAS_BLENDMODE,
                    mode: a
                })
            },
            cdcs: function() {
                this.frame.push({
                    type: this.CANVAS_DOC_START,
                    time: Date.now()
                })
            },
            cdcp: function() {
                this.frame.push({
                    type: this.CANVAS_DOC_STOP,
                    time: Date.now()
                })
            },
            csbs: function() {
                this.frame.push({
                    type: this.CANVAS_SPRITE_BATCH_START,
                    time: Date.now()
                })
            },
            ...
            csbp: function() {
                this.frame.push({
                    type: this.CANVAS_SPRITE_BATCH_STOP,
                    time: Date.now()
                })
            },
            ct: function(a, b, c, d) {
            ...
            cm: function(a) {
                this.frame.push({
                    type: this.CANVAS_MASK_PUSH,
                    mask: a
                })
            },
            cmo: function() {
                this.frame.push({
                    type: this.CANVAS_MASK_POP
                })
            },
            record: function(a) {
            ...
            update: function(a) {
                ...
                if (this._spiraling > 1 && !this.forceSingleUpdate) this.time.time > this._nextFpsNotification && (this._nextFpsNotification = this.time.time + 1e4,
                    this.fpsProblemNotifier.dispatch()), this._deltaTime = 0, this._spiraling = 0, this.updateRender(this.time.slowMotion * this.time.desiredFps);
                else {
        ...
        }, c.InputHandler.prototype.constructor = c.InputHandler, c.Component = function() {}, c.Component.Angle = function() {}, c.Component.Angle.prototype = {
            angle: {
                get: function() {
        ...
        c.Button.prototype.clearFrames = function() {
            ...
            if (this.playStateSound(i), this.onInputUp && this.onInputUp.dispatch(this, b, c), !this.freezeFrames)
                if (this.forceOut === !0 || (this.forceOut & b.pointerMode) === b.pointerMode) this.changeStateFrame(g);
                else {
            ...
            for (var b = a.split(/(?:\r\n|\r|\n)/), c = this.style.tabs, d = [], e = 0, f = this.determineFontProperties(this.style.font), g = 0; g < b.length; g++) {
                if (0 === c) var h = this.context.measureText(b[g]).width + this.style.strokeThickness + this.padding.x;
                else {
                    var i = b[g].split(/(?:\t)/),
            ...
            var n = f.fontSize + this.style.strokeThickness + this.padding.y,
                o = n * b.length,
                p = this._lineSpacing;
        ...
        }), c.Text.fontPropertiesCache = {}, c.Text.fontPropertiesCanvas = PIXI.CanvasPool.create(c.Text.fontPropertiesCanvas), c.Text.fontPropertiesContext = c.Text.fontPropertiesCanvas.getContext("2d"), c.TileSprite = function() {}, c.Device = function() {
        ...
        return c.Net = l, c.Net.prototype = {
            ...
            getFrameIndexes: function(a, b, c) {
                if (void 0 === b && (b = !0), void 0 === c && (c = []), void 0 === a || 0 === a.length)
                    ...
                    for (var d = 0; d < a.length; d++) b ? c.push(this._frames[a[d]].index) : this.getFrameByName(a[d]) && c.push(this.getFrameByName(a[d]).index);
                return c
            }
            ...
            getParentBounds: function(a) {
                ...
                if (d) {
                    var g = d.getBoundingClientRect(),
                        h = d.offsetParent.getBoundingClientRect();
        ...
        }, c.LinkedList.prototype.constructor = c.LinkedList, c.Create = function() {}, c.Color = {
...
Phaser.ParticleStorm.Particle.prototype = {
    ...
    radiateFrom: function(U, E, k) {
        ...
        var F = (b6U["P0"](this.transform["x"], U)),
            X = (b6U["m0"](this.transform["y"], E)),
    ...
    target: function(U) {
        ...
        var X = Math["atan2"](b6U["g0"](k, f["y"]), b6U["B0"](E, f["x"])),
            v = b6U["w0"](f["x"], E),
            s = b6U["b0"](f["y"], k),
            o = b6U["u0"](Math["sqrt"](v * v + s * s), (this["lifespan"] / 1000)),
            R = b6U["U6"]((Math["cos"](X) * o), f["time"]["physicsElapsed"]),
            A = b6U["E6"]((Math["sin"](X) * o), f["time"]["physicsElapsed"]);
        if (U.speed) {
            this["graph"]["fromControl"]({
                value: b6U["k6"](R, 2),
                control: U.speed
            }, f["velocity"]["x"]);
            this["graph"]["fromControl"]({
...
Phaser.ParticleStorm.GravityWell.prototype = {
    step: function(U) {
        var E = b6U["j6"](this["position"]["x"], U.transform["x"]),
            k = b6U["Y6"](this["position"]["y"], U.transform["y"]),
            f = b6U["V6"](E, E) + b6U["G6"](k, k);
        if (b6U["r6"](f, 0)) {
            return;
        }
        var F = Math["sqrt"](f);
...
Phaser["ParticleStorm"]["Graph"] = {
    ...
    getControlValues: function(U, E, k) {
        var f = Phaser["ParticleStorm"]["Graph"]["getControlValue"](U, E),
            F = [{
                x: E,
                y: f
            }];
        ...
        F["push"]({
            x: k,
            y: Phaser["ParticleStorm"]["Graph"]["getControlValue"](U, k)
        });
        return F;
    },
    ...
    getValue: function(U, E) {
        ...
        var f = b6U["m7"](U["control"].length, 1),
            F = U["control"][f];
        if (b6U["l7"](F["x"], E)) {
            return F["y"];
        }
    ...
    init: function(U, E, k) {
        ...
        if (k["hasOwnProperty"]('velocity')) {
            if (this["graph"]["isNumeric"](k["velocity"])) {
                ...
                var s = this["graph"]["getMinMaxInitial"](k["velocity"]),
                    o = k["velocity"]["radial"]["arcStart"],
                    R = k["velocity"]["radial"]["arcEnd"];
                if (b6U["p4I"](o, undefined) && b6U["x4I"](R, undefined)) {
                    var A = b6U["F4I"]((Math["random"]() * (R - o) + o), Math["PI"], 180.0),
                        Q = Math["sin"](A),
                        J = -Math["cos"](A);
...
Phaser.ParticleStorm.Renderer.Pixel.prototype.update = function(U) {
    ...
    var E = Math["floor"](U.transform["x"]),
        k = Math["floor"](U.transform["y"]),
        f = U["color"]["red"]["calc"],
        F = U["color"]["green"]["calc"],
        X = U["color"]["blue"]["calc"],
